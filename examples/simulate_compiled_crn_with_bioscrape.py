...
plt.plot(timepoints, result[:, rna_rep_ribo_ind], color = 'blue', label = "complex_rna_T1:protein_Ribo")
plt.plot(timepoints, result[:, rna_rep_ase_ind], color ='cyan', label = "complex_rna_T1:protein_RNAase")
plt.plot(timepoints, result[:, protein_Ribo_ind], color ='pink', label = "protein_Ribo")

plt.plot(timepoints, result_d[:, rna_rep_ind_d], ":", color = 'darkred', label = "rna_Reporter_d")
plt.plot(timepoints, result_d[:, rna_rep_ribo_ind_d], ":", color = 'darkblue',label = "complex_rna_T1:protein_Ribo_d")
plt.plot(timepoints, result_d[:, rna_rep_ase_ind_d], ":", color ='green', label = "complex_rna_T1:protein_RNAase_d")
plt.plot(timepoints, result_d[:, protein_Ribo_ind_d], ":", color ='purple', label = "protein_Ribo_d")
