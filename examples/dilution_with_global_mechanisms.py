...
kb, ku, ktx, ktl, kdeg, kdil = 100, 10, 3, 2, .5, .05
...
print("myMixture.rnap", repr(myMixture.rnap.specie))
print("myMixture.RNAase", repr(myMixture.RNAase.specie))
print("myMixture.ribosome", repr(myMixture.ribosome.specie))
...
print("repr(A_genome.get_specie())", repr(A_genome.get_specie()))
...
x0_dict = {repr(myMixture.ribosome.get_specie()):1000, repr(myMixture.rnap.get_specie()):50, repr(myMixture.RNAase.get_specie()):10, repr(A_dna.dna):10, repr(A_genome.dna):10}
