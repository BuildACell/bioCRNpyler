...
A1 = DNAassembly(
    name='G1', promoter='P', rbs='BCD', transcript='T1', protein='Reporter'
)
...
start = pytime.clock()
result = CRN.simulate_with_bioscrape_deterministic_via_sbml(
    timepoints, f, initial_condition_dict
)
end = pytime.clock()
...
plt.plot(
    timepoints,
    result['complex_rna_T1_protein_Ribo'],
    color='blue',
    label='complex_rna_T1:protein_Ribo',
)
plt.plot(
    timepoints,
    result['complex_rna_T1_protein_RNAase'],
    color='cyan',
    label='complex_rna_T1:protein_RNAase',
)
plt.plot(
    timepoints, result['protein_Ribo'], color='pink', label='protein_Ribo'
)
...
plt.plot(
    ...
    ':',
    color='darkred',
    label='rna_Reporter_d',
)
plt.plot(
    timepoints,
    result_d['complex_rna_T1_protein_Ribo'],
    ':',
    color='darkblue',
    label='complex_rna_T1:protein_Ribo_d',
)
plt.plot(
    timepoints,
    result_d['complex_rna_T1_protein_RNAase'],
    ':',
    color='green',
    label='complex_rna_T1:protein_RNAase_d',
)
plt.plot(
    timepoints,
    result_d['protein_Ribo'],
    ':',
    color='purple',
    label='protein_Ribo_d',
)
...
plt.subplot(122)
plt.plot(
    timepoints, result['protein_Reporter'], color='green', label='Reporter'
)

plt.plot(
    timepoints,
    result_d['protein_Reporter'],
    ':',
    color='darkgreen',
    label='Reporter_d',
)
