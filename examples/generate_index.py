...
species = [(n, o) for (n, o) in inspect.getmembers(sys.modules["biocrnpyler"]) if inspect.isclass(o) and issubclass(o, biocrnpyler.Species)]

propensities = [(n, o) for (n, o) in inspect.getmembers(sys.modules["biocrnpyler"]) if inspect.isclass(o) and issubclass(o, biocrnpyler.Propensity)]

components = [(n, o) for (n, o) in inspect.getmembers(sys.modules["biocrnpyler"]) if inspect.isclass(o) and issubclass(o, biocrnpyler.Component)]

mechanisms = [(n, o) for (n, o) in inspect.getmembers(sys.modules["biocrnpyler"]) if inspect.isclass(o) and issubclass(o, biocrnpyler.Mechanism)]
...
for path in paths:
    ...
    for fname in ipynb_files:
        ...
        for line in f:
            ...
            for c in first_used:
                if c in line and first_used[c] == None:
                    if path == ".":
                        first_used[c] = fname
                    else:
