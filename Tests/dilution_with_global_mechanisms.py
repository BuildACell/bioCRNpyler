import txtl
import dna_assembly
import global_mechanism as gmech
...
dilution_mechanism = gmech.Dilution(filter_dict = {"genome":False})

#Add this mechanism to a dictionary which is passed into the Mixture txtl.BasicExtract
global_mechanisms = {"dilution":dilution_mechanism}
myMixture = txtl.BasicExtract(name = "txtl", parameters = parameters, global_mechanisms = global_mechanisms)

#Creates a dna assembly. This assembly is type "dna" so it will be degraded
A_dna = dna_assembly.DNAassembly(name = "G1", promoter = "pBest",
                              rbs = "BCD2")
...
A_genome = dna_assembly.DNAassembly(name = "G2", promoter = "pBest",
                              rbs = "BCD2")
