...
x0_no_dcas = {repr(const_dCas_assembly.dna):0, repr(reg_assembly.dna):1, repr(const_gRNA_assembly.dna):10, "complex_Ribo":20, "protein_RNAP":10, "protein_RNAase":10}
x0_with_dcas = {repr(const_dCas_assembly.dna):2., repr(reg_assembly.dna):1, repr(const_gRNA_assembly.dna):10, "complex_Ribo":20, "protein_RNAP":10, "protein_RNAase":10}
