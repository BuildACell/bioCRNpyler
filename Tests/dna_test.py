...
class DNATest(unittest.TestCase):
    def test_DNA(self):
        ...
        with self.assertRaises(ValueError) as context:
            ...
            self.assertTrue('non-negative length was enforced' in context.exception)
        ...
        with self.assertRaises(ValueError) as context:
            dna.initial_concentration = -1

            self.assertTrue('non-negative initial concentration was enforced' in context.exception)
