...
class TestMixture(TestCase):
    def test_add_species(self):
        ...
        with self.assertRaisesRegex(
            AssertionError, 'only Species type is accepted!'
        ):
    ...
    def test_add_components(self):
        ...
        self.assertTrue(
            mixture.get_component(component=component) is not None
        )
    ...
    def test_get_component(self):
        ...
        # test with component
        self.assertTrue(
            type(mixture.get_component(component=c1)) is Component
        )
        self.assertTrue(
            type(mixture.get_component(component=c2)) is Component
        )
    ...
    def test_add_mechanisms(self):
        ...
        self.assertTrue(
            isinstance(mixture.mechanisms, dict)
            and len(mixture.mechanisms) == 0
        )
        ...
        self.assertEqual(
            type(mixture.mechanisms[tx.mechanism_type]),
            type(test_mech[tx.mechanism_type]),
        )
        self.assertFalse(
            mixture.mechanisms[tx.mechanism_type]
    ...
    def test_compile_crn(self):
        ...
        def mock_update_reactions():
            rxn = Reaction.from_massaction(
                inputs=[a], outputs=[b], k_forward=0.1
            )
            return [rxn]
        ...
        self.assertTrue(
            all(
                [
                    ...
                    for ss in crn_from_mixture.species
                ]
            )
        )
        ...
        self.assertTrue(
            all(
                [
                    ...
                    for rr in crn_from_mixture.reactions
                ]
            )
        )
    ...
    def test_compile_crn_directives(self):
        ...
        crn_from_mixture3 = mixture.compile_crn(
    ...
    def test_compoents_in_multiple_mixtures(self):
        ...
        self.assertTrue(
            M1.get_component(component=C) != M2.get_component(component=C)
        )
