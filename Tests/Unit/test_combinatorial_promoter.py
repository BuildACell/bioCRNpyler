...
class TestCombinatorialPromoter(TestCase):
    def test_initialization(self):
        ...
        self.assertTrue(
            newprom.regulators == [Species('treg1', material_type='protein')]
        )
        ...
        self.assertTrue(
            newprom2.regulators
            == [
                Species('treg1', material_type='protein'),
        ...
        self.assertTrue(
            newprom2.tx_capable_list
            == [{'treg1'}, {'treg2'}, {'treg1', 'treg2'}]
        )

        # you should be able to define a tx_capable_list
        newprom3 = CombinatorialPromoter(
            'testprom',
            ['treg1', 'treg2'],
        ...
        self.assertTrue(
            newprom3.tx_capable_list == [{'treg1', 'treg2'}, {'treg2'}]
        )

        # if you define it with a species in the regulators it should work
        newprom4 = CombinatorialPromoter(
            'testprom', ['treg1', Species('treg2', material_type='rna')]
        )
        print(newprom4.tx_capable_list)
        self.assertTrue(
            newprom4.tx_capable_list
            == [{'treg1'}, {'treg2'}, {'treg1', 'treg2'}]
        )
        self.assertTrue(
            newprom4.regulators
    ...
    def test_update_species(self):
        ...
        newprom = CombinatorialPromoter(
            'testprom',
            ['treg1', Species('treg2', material_type='rna')],
            tx_capable_list=[['treg1', 'treg2']],
        ...
        newdna.add_mechanisms(
            {
                'transcription': Transcription_MM(rnap=sp_rnap),
                'translation': Translation_MM(ribosome=ribosome),
            }
        )
        ...
        if mistake_found:
            raise ValueError(
                f'Mistake found in Species output:{error_txt}. Returned Species: {test_set}.'
            )
    ...
    def test_update_reactions(self):
        ...
        parameters = {
            ...
            'ktx': 0.05,
            ParameterKey(
                mechanism=None, part_id='testprom_leak', name='ktx'
            ): 0.01,
            ParameterKey(
                mechanism=None, part_id='testprom_leak', name='ku'
            ): 50,
            ParameterKey(
                mechanism=None, part_id='testprom_treg1_treg2_RNAP', name='ku'
            ): 5,
        }
        ...
        r3 = [
            set([sp_dna_treg1, sp_rnap]),
            set([sp_dna_treg1_rnap]),
            100,
            50,
        ]  # rnap binding to treg1 bound dna
        r4 = [
            set([sp_dna_treg1_rnap]),
            set([sp_dna_treg1, sp_rnap, sp_rna]),
            0.01,
            None,
        ]  # leaky tx from single regulator
        r5 = [
            set([sp_dna_treg2_rnap]),
            set([sp_dna_treg2, sp_rnap, sp_rna]),
            0.01,
            None,
        ]  # leaky tx from single regulator
        r6 = [
            set([sp_dna_treg1_treg2_rnap]),
            set([sp_dna_treg1_treg2, sp_rnap, sp_rna]),
            0.05,
            None,
        ]  # ktx for regular tx
        r7 = [
            set([sp_dna_treg2, sp_rnap]),
            set([sp_dna_treg2_rnap]),
            100,
            50,
        ]  # rnap binding to treg2 bound dna
        r8 = [
            set([sp_dna, sp_treg2]),
            set([sp_dna_treg2]),
            100,
        ...
        for rxn in newprom_rxns:
            in_outs = [
                set([i.species for i in rxn.inputs]),
                set([o.species for o in rxn.outputs]),
            ]
            correctPick = False
        ...
        newprom2 = CombinatorialPromoter(
            'testprom',
            ['treg1'],
            parameters=parameters,
            tx_capable_list=[],
        ...
        self.assertWarnsRegex(
            UserWarning, 'nothing can transcribe', newdna2.update_reactions
        )
