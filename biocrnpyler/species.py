...
class Species(OrderedMonomer):
    ...
    def __init__(self, name: str, material_type="", attributes: Union[List,None] = None,
                 initial_concentrationentration=0, **keywords):
        OrderedMonomer.__init__(self,**keywords)

        self.name = name
        self.material_type = material_type
        self.initial_concentrationentration = initial_concentrationentration
    ...
    def pretty_print(self, show_material = True, show_attributes = True, show_initial_condition = False, **kwargs):
        ...
        if show_initial_condition:
            txt+=f" init_conc = {self.initial_concentrationentration}"
...
class ComplexSpecies(Species):
    ...
    """
    def __init__(self, species: List[Union[Species,str]], name: Union[str,None] = None, material_type = "complex", attributes = None, initial_concentrationentration = 0, **keywords):
        ...
        #call super class
        Species.__init__(self, name = name, material_type = material_type, attributes = attributes, initial_concentrationentration = initial_concentrationentration)
...
class Multimer(ComplexSpecies):
    ...
    """
    def __init__(self, species, multiplicity, name = None, material_type = "complex", attributes = None, initial_concentrationentration = 0, **keywords):
        ...
        ComplexSpecies.__init__(self, species = species*multiplicity, name = name, material_type = material_type, attributes = attributes, initial_concentrationentration = initial_concentrationentration, **keywords)   
...
class OrderedComplexSpecies(ComplexSpecies):
    ...
    def __init__(self, species, name = None, material_type = "ordered_complex", attributes = None, initial_concentrationentration = 0, **keywords):
        #Set species because it is used for default naming
        if len(Species.flatten_list(species)) <= 1:
            raise ValueError("chemical_reaction_network.complex requires 2 "
                             "or more species in its constructor.")
...
class OrderedPolymerSpecies(OrderedComplexSpecies,OrderedPolymer):
    ...
    def __init__(self,species, name=None, base_species = None, material_type = default_material, \
                             attributes = None, initial_concentrationentration = 0,circular = False):
